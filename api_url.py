...
class ApiUrl:
    ...
    def skip_sectiontime_api(self) -> str:
        return f"{self.__host}/account/session/api/study/time"
    def skip_sectiontime_user_api(self) -> str:
        return f"{self.__host}/account/session/api/login/time"
